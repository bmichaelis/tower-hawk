package org.towerhawk.monitor.check.execution.system;
...
import org.towerhawk.monitor.check.execution.system.util.OSHIUtil;
...
public class CPUCheck implements CheckExecutor {
	...
	@Override
	public void init(CheckExecutor checkExecutor, Check check, Configuration configuration) {
